// Implementing the proper useToast hook
...
function useToast() {
  ...
  return {
    ...
    clearAll: () => dispatch({ type: actionTypes.CLEAR_TOASTS }),
    toasts: state.toasts,
    ...
    removeAll: () => dispatch({ type: actionTypes.CLEAR_TOASTS }),
    unreadCount: state.toasts.filter((t) => t.open).length,
  }
}
